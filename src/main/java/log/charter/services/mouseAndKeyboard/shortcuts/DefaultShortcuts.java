...
public class DefaultShortcuts extends ShortcutList {
	...
	private DefaultShortcuts() {
		...
		super.set(Action.MOVE_FRET_DOWN, new Shortcut(KeyEvent.VK_DOWN).alt());
		super.set(Action.MOVE_FRET_DOWN_OCTAVE, new Shortcut(KeyEvent.VK_DOWN).alt().shift());
		super.set(Action.MOVE_FRET_UP, new Shortcut(KeyEvent.VK_UP).alt());
		super.set(Action.MOVE_FRET_UP_OCTAVE, new Shortcut(KeyEvent.VK_UP).alt().shift());
		super.set(Action.MOVE_STRING_DOWN, new Shortcut(KeyEvent.VK_DOWN));
		super.set(Action.MOVE_STRING_DOWN_SIMPLE, new Shortcut(KeyEvent.VK_DOWN).ctrl());
		super.set(Action.MOVE_STRING_UP, new Shortcut(KeyEvent.VK_UP));
		super.set(Action.MOVE_STRING_UP_SIMPLE, new Shortcut(KeyEvent.VK_UP).ctrl());
		...
		super.set(Action.TOGGLE_ACCENT_INDEPENDENTLY, new Shortcut(KeyEvent.VK_A).alt());
		super.set(Action.TOGGLE_ANCHOR, new Shortcut(KeyEvent.VK_A));
		super.set(Action.TOGGLE_BORDERLESS_PREVIEW_WINDOW, new Shortcut(KeyEvent.VK_F12));
		super.set(Action.TOGGLE_CLAPS, new Shortcut(KeyEvent.VK_F3));
		super.set(Action.TOGGLE_HARMONIC, new Shortcut(KeyEvent.VK_O));
		...
		super.set(Action.TOGGLE_VIBRATO, new Shortcut(KeyEvent.VK_V));
		super.set(Action.TOGGLE_VIBRATO_INDEPENDENTLY, new Shortcut(KeyEvent.VK_V).alt());
