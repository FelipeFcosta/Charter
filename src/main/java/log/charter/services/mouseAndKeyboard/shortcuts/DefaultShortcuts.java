...
public class DefaultShortcuts extends ShortcutList {
	...
	private DefaultShortcuts() {
		...
		super.set(Action.STEM_NEXT, new Shortcut(KeyEvent.VK_TAB).ctrl());
		super.set(Action.STEM_PREVIOUS, new Shortcut(KeyEvent.VK_TAB).ctrl().shift());
		...
		super.set(Action.SPEED_TOGGLE, new Shortcut(KeyEvent.VK_R).shift());
		...
		super.set(Action.TOGGLE_TREMOLO_INDEPENDENTLY, new Shortcut(KeyEvent.VK_T).alt());		super.set(Action.TOGGLE_UNPITCHED_SLIDE, new Shortcut(KeyEvent.VK_U));		super.set(Action.TOGGLE_VIBRATO, new Shortcut(KeyEvent.VK_V));
