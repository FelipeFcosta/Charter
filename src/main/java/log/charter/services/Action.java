...
public enum Action {
	...
	STEM_NEXT(TEMPO_MAP, VOCALS, GUITAR), //
	STEM_PREVIOUS(TEMPO_MAP, VOCALS, GUITAR), //
	BEAT_ADD(TEMPO_MAP), //
	...
	MARK_HAND_SHAPE_FROM_NOTES(GUITAR), //
	...
	PASTE(VOCALS, GUITAR), //
	PLAY_SELECTED_NOTES_SOUND(Label.PLAY_SELECTED_NOTES_SOUND, GUITAR), //
	...
	SPEED_TOGGLE(TEMPO_MAP, VOCALS, GUITAR), //
	...
	TOGGLE_LINK_NEXT_BEFORE(GUITAR), //
